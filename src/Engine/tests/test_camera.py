...
def horizontal_camera():
	return Camera(None, (5, 0, 0), (0, 0, 0), fov_angle=60)

@pytest.fixture()
def oblique_camera():
	return Camera(None, (3, 0, 4), (0, 0, 0), fov_angle=60)  # for 3 4 5 tri (rect tri)

@pytest.fixture()
def not_centered_camera():
	return Camera(None, (3+5, 0+5, 4+5), (0+5, 0+5, 0+5), fov_angle=60)
